    ...
    return (
        <div className="max-w-screen-2xl mx-auto">
            ...
            <div className='flex justify-center'>
                <div className='form'>
                    <input className=' w-96 px-5  py-2 my-2 border-[1px] border-gray-400 rounded-lg outline-none' type="text" placeholder='Email Address' /> <br />

                    <input className=' w-96 px-5  py-2 my-2 border-[1px] border-gray-400 rounded-lg outline-none' type="text" placeholder='Password' />
                </div>
            </div>
