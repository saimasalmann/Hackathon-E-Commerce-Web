    ...
    return (
        <div className="max-w-screen-2xl mx-auto" >
            ...
            <div className='flex justify-center'>
                <div className='form'>
                    <input className=' w-96 px-5  py-2 my-2 border-[1px] border-grey-300' type="text" placeholder='Email Address' /> <br />

                    <input className=' w-96 px-5  py-2 my-2 border-[1px] border-grey-300' type="text" placeholder='Password' /><br />

                    <input className=' w-96 px-5  py-2 my-2 border-[1px] border-grey-300' type="text" placeholder='First Name' /> <br />

                    <input className=' w-96 px-5  py-2 my-2 border-[1px] border-grey-300' type="text" placeholder='Last Name' /> <br />

                    <input className=' w-96 px-5  py-2 my-2 border-[1px] border-grey-300' type="text" placeholder='Date of Birth' /> <br />
                    ...
                    <div className='flex justify-between'>
                        <input className=' w-[180px] px-5  py-2 my-2 border-[1px] border-grey-300 ' type="text" placeholder='Male' />
                        <input className=' w-[180px] px-5  py-2 my-2 border-[1px] border-grey-300' type="text" placeholder='Female' />
